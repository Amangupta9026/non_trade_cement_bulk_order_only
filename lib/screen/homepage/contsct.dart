          ...
          child: ScrollConfiguration(
            ...
            child: FutureBuilder(
                ...
                builder: (context, AsyncSnapshot<QuerySnapshot> snapshot) {
                   String number = snapshot.data?.docs[1]['mobile'] ?? '';
                                String address = snapshot.data?.docs[1]['address'] ?? '';
                                String email = snapshot.data?.docs[1]['email'] ?? '';
                                                ...
                                                children: [
                                                  ...
                                                  DropdownButtonFormField(
                                                    decoration: InputDecoration(
                                                        ...
                                                        enabledBorder: OutlineInputBorder(
                                                            borderRadius:
                                                                BorderRadius.circular(
                                                                    10.0),
                                                            borderSide: BorderSide(
                                                                color: refWatch.value?.selectedGender ==
                                                                        null
                                                                    ? Colors
                                                                        .grey
                                                                    : Colors
                                                        ...
                                                        errorBorder: OutlineInputBorder(borderRadius: BorderRadius.circular(10.0), borderSide: BorderSide(color: refWatch.value?.selectedGender == null ? Colors.white : Colors.grey))),
                                                    icon: const Icon(Icons
                                                        .keyboard_arrow_down_rounded),
                                                    elevation: 1,
                                                    hint: const Text(
